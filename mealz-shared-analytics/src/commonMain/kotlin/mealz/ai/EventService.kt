...
object EventService : EventSender {
    ...
    private val PROPS_FOR_EVENT = PlatformMap(
        ...
        PlausibleDestinations.ENTRY_REPLACE.plausiblePath to propsOf(PlatformList("entry_name", "item_id", "ext_item_id", "item_ean", "product_quantity"), PlatformList("recipe_id", "status")),
